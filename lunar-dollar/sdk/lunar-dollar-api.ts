// lunar-dollar-api.ts
// Lunar-dollar Project API
// DO NOT EDIT - Generated by generate-canton-api.ts
//
// This file contains all workflows and operations available in the lunar-dollar project.
...
export namespace PaymentReceiver {
  ...
  export interface Payload {
    ...
    instrumentKey: InstrumentKey;
    prices: DamlMap<string, Numeric>;
    publicParty: Party;
  }

  /** Create a new PaymentReceiver contract */
  export function create(payload: Payload): Command<Payload> {
    return {
 ...
 * Choices: ConsumeAccess
 *
 * @example
 * const cmd = PaymentReceiver_AccessGrant.create({ receiver: 'alice::1220...', payer: 'alice::1220...', resource: 'example' });
 * const contractId = await ledger.create(cmd.templateId, cmd.argument);
 */
export namespace PaymentReceiver_AccessGrant {
  ...
  /** Create a new AccessGrant contract */
  export function create(payload: Payload): Command<Payload> {
    return {
  ...
  /** Exercise ConsumeAccess choice */
  export function consumeAccess(
    contractId: ContractId<Payload>,
    args: Record<string, unknown> /* Unparsed args type: ConsumeAccess */
  ): Command<void> {
    return {
      templateId: TemplateIds.PaymentReceiver_AccessGrant,
 ...
 *
 * @example
 * const cmd = TransferRequest.create({ receiverAccount: {...}, instrument: {...}, amount: '100.0' });
 * const contractId = await ledger.create(cmd.templateId, cmd.argument);
 */
export namespace TransferRequest {
  ...
  /** Create a new TransferRequest contract */
  export function create(payload: Payload): Command<Payload> {
    return {
