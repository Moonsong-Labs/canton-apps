...
import { ComplianceDashboard, BlacklistManager, ClaimsManager, IdentityManager } from '@/features/compliance';
    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          <Route path="/compliance/blacklist/:id" element={<BlacklistManager />} />
